    ...
    map.on("load", () => {
      map.addSource("corridor", {
        ...
        data: { type: "Feature", geometry: { type: "LineString", coordinates: [
          [-91.18, 30.44], [-90.85, 30.1], [-90.37, 29.96],
          [-90.07, 29.95], [-90.05, 29.92], [-89.95, 29.75],
          [-89.7, 29.35],  [-89.41, 29.00],
        ]}},
      });
      map.addLayer({ id: "corridor-line", type: "line", source: "corridor",
        layout: { "line-join": "round", "line-cap": "round" },
        paint: { "line-color": "#3bbfb2", "line-width": 2.5, "line-opacity": 0.5 },
      });
  ...
  return (
    <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", height: 300 }}>
        ...
        {/* Agent overlay */}
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(to top, #040404f0 0%, #040404aa 60%, transparent 100%)", padding: "14px 16px 12px", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
    ...
    <>
      <style>{`
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .row3-grid{display:grid;grid-template-columns:1fr 1fr 260px;gap:16px;}
          ...
          <div style={{ padding: "20px 28px", display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <div className="row1-grid">
              ...
              <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, padding: "18px 20px" }}>
                <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: C.muted, letterSpacing: "0.1em", marginBottom: 14, display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  <span>CARROLLTON GAUGE · 8761927</span>
                  {gaugeData ? <Badge color={C.teal}>NOAA LIVE</Badge> : <Badge color={C.muted}>SIMULATED</Badge>}
                </div>
                <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 52, fontWeight: 700, color: scenario.statusColor, lineHeight: 1, marginBottom: 4, textShadow: `0 0 24px ${scenario.statusColor}55` }}>
              ...
              {/* OODA */}
              <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, padding: "18px 20px" }}>
                <div style={{ fontFamily: "'JetBrains Mono',monospace", fontSize: 10, color: C.muted, letterSpacing: "0.1em", marginBottom: 16 }}>OODA LOOP · CURRENT CYCLE</div>
            ...
            <div className="row3-grid">
              ...
              <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
                ...
                <div ref={logRef} style={{ height: 280, overflowY: "auto", padding: "12px 16px" }}>
                  {log.length === 0 && (
