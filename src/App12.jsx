...
// Precise Mississippi River navigation channel coordinates
// Based on NOAA Chart 11370 (Baton Rouge to New Orleans) and 11371 (New Orleans to Gulf)
const RIVER_COORDS = [
  [-91.1837, 30.4382], // Baton Rouge — Mile 232 AHP
  [-91.1500, 30.4100],
  [-91.1200, 30.3800],
  [-91.0800, 30.3400],
  [-91.0300, 30.3100],
  ...
  [-90.4000, 29.9600],
  [-90.3800, 29.9580],
  [-90.3674, 29.9554], // Globalplex — Mile 154 AHP
  [-90.3400, 29.9520],
  [-90.3100, 29.9480],
  [-90.2800, 29.9440],
  [-90.2500, 29.9400],
  ...
  [-90.1900, 29.9330],
  [-90.1700, 29.9310],
  [-90.1500, 29.9330], // Huey P. Long Bridge — Mile 106 AHP
  [-90.1300, 29.9370],
  [-90.1112, 29.9499], // Carrollton Gauge — Mile 102 AHP
  [-90.0950, 29.9550],
  [-90.0800, 29.9600], // Audubon Park bend
  [-90.0650, 29.9580],
  [-90.0500, 29.9520],
  [-90.0350, 29.9430],
  [-90.0200, 29.9350],
  ...
  [-89.4500, 29.1300],
  [-89.4200, 29.0650],
  [-89.4073, 28.9947], // Southwest Pass — Mile 0 AHP
];
