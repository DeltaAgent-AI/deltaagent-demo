...
const VESSEL_ROUTE = [
  [-91.1, 30.4],   // Baton Rouge area
  [-90.85, 30.1],  // Mid corridor
  [-90.37, 29.97], // Globalplex
  [-90.2,  29.95], // Approaching NOLA
  [-90.07, 29.93], // Napoleon Ave Wharf area
];
  ...
  return (
    <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", height: 320 }}>
        ...
        {/* Agent overlay — sits above attribution (28px) */}
        <div style={{ position: "absolute", bottom: 28, left: 0, right: 0, background: "linear-gradient(to top, #040404f0 0%, #040404aa 70%, transparent 100%)", padding: "20px 16px 10px", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
          ...
          <div style={{ padding: "16px 28px", display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div className="row3-grid">
              ...
              <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
                ...
                <div ref={logRef} style={{ height: 240, overflowY: "auto", padding: "12px 16px" }}>
                  {log.length === 0 && (
