...
// Vessel route — Baton Rouge to Napoleon Ave Wharf ONLY
// Stays within visible map frame, follows river closely through crescent
const VESSEL_ROUTE = [
  ...
  [-90.1112, 29.9699], // Carrollton Gauge
  [-90.0880, 29.9760], // Audubon crescent peak
  [-90.0650, 29.9720],
  [-90.0450, 29.9600],
  [-90.0250, 29.9450], // Napoleon Ave Wharf — end point
];
