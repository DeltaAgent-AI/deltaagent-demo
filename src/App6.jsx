  ...
  return (
    <div style={{ background: C.panel, border: `1px solid ${C.border}`, borderRadius: 8, overflow: "hidden" }}>
      ...
      <div style={{ position: "relative", height: 320 }}>
        ...
        {/* Agent overlay */}
        <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, background: "linear-gradient(to top, #040404f0 0%, #040404aa 60%, transparent 100%)", padding: "14px 16px 28px", display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
