...
function RiverMap({ gaugeVal, statusColor, log }) {
  ...
  function initMap() {
    ...
    map.on("load", () => {
      // Highlight the Mississippi River using Mapbox's water fill layer
      map.setPaintProperty("water", "fill-color", "#1a4a5c");

      // Add a subtle glow line along the river using waterway layer
      map.addLayer({
        id: "corridor-line",
        type: "line",
        source: "composite",
        ...
        filter: ["all",
          ["==", ["get", "class"], "river"],
          ["in", ["get", "name"], ["literal", ["Mississippi River", "Mississippi"]]]
        ],
        layout: { "line-join": "round", "line-cap": "round" },
        paint: { "line-color": "#3bbfb2", "line-width": 2, "line-opacity": 0.6 },
      });
