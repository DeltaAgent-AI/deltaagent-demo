...
// Accurate Mississippi River channel coordinates
// Baton Rouge → New Orleans crescent → Southwest Pass
const RIVER_COORDS = [
  [-91.1837, 30.4382], // Baton Rouge — Horace Wilkinson Bridge
  [-91.1200, 30.3800],
  [-91.0300, 30.3200],
  [-90.9400, 30.2600],
  [-90.8700, 30.2000],
  ...
  [-90.6200, 30.0500],
  [-90.5600, 30.0200],
  [-90.4900, 29.9900], // Kenner area
  [-90.4500, 29.9750],
  [-90.4100, 29.9650], // Globalplex / River Road
  [-90.3674, 29.9554], // Associated Terminals / Globalplex
  [-90.3200, 29.9500],
  [-90.2800, 29.9480],
  [-90.2400, 29.9420],
  [-90.2000, 29.9350],
  [-90.1700, 29.9300],
  [-90.1400, 29.9350], // Huey P Long Bridge area
  [-90.1112, 29.9499], // Carrollton Gauge — start of crescent
  [-90.0900, 29.9550],
  [-90.0700, 29.9600], // Audubon Park bend
  [-90.0500, 29.9500],
  [-90.0300, 29.9350],
  [-90.0100, 29.9250],
  [-89.9900, 29.9150],
  [-89.9700, 29.9050], // Lower 9th Ward area
  [-89.9500, 29.8900],
  [-89.9200, 29.8700],
  [-89.9000, 29.8500],
  [-89.8700, 29.8200],
